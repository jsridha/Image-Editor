...
/**
 * Class that performs a greyscale shift for an Image object using the intensity parameter.
 */
public class VisualizeIntensityTransform extends AbsVisualizeTransform {

  /**
   * Constructor for Transformation Object.
   */
  public VisualizeIntensityTransform() {
