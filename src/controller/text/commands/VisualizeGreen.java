 ...
 */
public class VisualizeGreen implements ICommand {

  /**
   * Empty constructor.
   */
  public VisualizeGreen() {
  ...
  public void run(Scanner scan, IImageDB model, IView view) throws IllegalStateException {
    ...
    if (!scan.hasNext()) {
      throw new IllegalStateException("Second argument must be "
              + "the ID of the image to be modified.");
    }
    ...
    ITransformation visualize = new VisualizeGreenTransform();
