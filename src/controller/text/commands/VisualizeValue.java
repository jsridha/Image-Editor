...
/**
 * Defines a greyscale shift using value.
 */
public class VisualizeValue implements ICommand {

  /**
   * Empty constructor.
   */
  public VisualizeValue() {
  ...
  public void run(Scanner scan, IImageDB model, IView view) throws IllegalStateException {
    ...
    ITransformation visualize = new VisualizeValueTransform();
